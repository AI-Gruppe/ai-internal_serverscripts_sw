...
set_in_file "password required pam_pwquality.so try_first_pass retry=3 minlen=10 lcredit=1 ucredit=1 dcredit=2 ocredit=1 difok=1 reject_username" "/etc/pam.d/common-password"
